          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 col-14 mx-auto">
              ...
              <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="card-body">
                  <div class=" ">
                    <h5 class="card-title text-center pb-0 fs-5 fw-bold" style="color: #fd7e14;">Rénitialiser</h5>
                    ...
                    <div class="col-12">
                      ...
                      <br>
                    <div class="col-12">
                        <button class="btn w-100" style="background-color: #fd7e14; color: #fff;" type="submit">Rénitialiser</button>
                    </div>
                  </form>
