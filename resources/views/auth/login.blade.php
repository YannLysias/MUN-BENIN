                ...
                <div class="col-lg-5 col-md-8 col-14 mx-auto">
                    <div class="card px-4 flex gap-4 py-5">
                        <div class=" d-flex flex-column align-items-center">
                            <img src="/asset/img/logo.jpg" width="120px" alt="" class="img-fluid">
                            <h5 class="card-title pt-2 fs-5 fw-bold" style="color: #fd7e14;">Connexion</h5>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                <button class="btn w-100" class="get-started-btn" style="background-color: #fd7e14; color: #fff;" type="submit">Se connecter</button>
                            </div>
